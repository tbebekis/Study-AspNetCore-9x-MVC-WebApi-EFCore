namespace MvcApp.Library
{
    ...
    /// <para><strong>NOTE: It is NOT used.</strong> Actually any error ends up in the Error view, because of the <c>app.UseExceptionHandler("/Home/Error");</c> setting.</para>
    /// </summary>
